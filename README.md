...
Este README tem como objetivo fornecer uma compreensão detalhada do funcionamento e do código da versão **Linked List** do **get_next_line**. As explicações gerais sobre o desafio e a metodologia de teste estão disponíveis na branch [main](https://github.com/marcus848/get_next_line/tree/main/). Aqui, focaremos exclusivamente na implementação e no funcionamento do código.
